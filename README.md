...
- 🤖 **AI Agent Friendly** — Non-interactive `login`, `--json` output, dry-run support, and clear exit codes make it easy for [OpenClaw](https://github.com/openclaw/openclaw) and other AI agents to drive. [OpenClaw skill included](skills/pikpak/SKILL.md)
